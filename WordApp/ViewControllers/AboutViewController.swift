...
class AboutViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        aboutTextView.text = " You have 10 seconds to translate each word from English to Swedish, you provide the correct translation within the time limit, you earn points and move on to the next word, if you fail to translate a word before time runs out, you lose one life. Start the game with three lives, the game ends when you run out of lives, or time runs out and every word is correct. Try to get the highest score possible!"
