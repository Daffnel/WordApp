...
class ViewController: UIViewController {
    ...
    @IBOutlet weak var oneDirectionLabel: UILabel!
    @IBOutlet weak var secondDirectionLabel: UILabel!
    ...
    override func viewDidLoad() {
        ...
        oneDirectionLabel.text =  "English -> Swedish"
        secondDirectionLabel.text =  "Swedish -> English"
        swedishFlag.text = "Tap here to choose"
